      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
          ...
          <div className="p-6 bg-black border border-border-bright">
            ...
            <div className="text-3xl font-bold text-accent-red font-mono">{priorityCounts[1]}</div>
          </div>
          <div className="p-6 bg-black border border-border-bright">
            ...
            <div className="text-2xl font-bold text-white font-mono">
              ...
              <span className="text-zinc-600 ml-1">/{ms.complete + ms.in_progress + ms.pending + ms.verified || 0}</span>
            </div>
          </div>
          <div className="p-6 bg-black border border-border-bright">
